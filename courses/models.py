...
class Video(BasicClass):
    ...
    title_uz = models.CharField(max_length=255)
    title_ru = models.CharField(max_length=255)
    discraption_en = models.CharField(max_length=255,null=True,blank=True,default="")
    discraption_uz = models.CharField(max_length=255,null=True,blank=True,default="")
    discraption_ru = models.CharField(max_length=255,null=True,blank=True,default="")
