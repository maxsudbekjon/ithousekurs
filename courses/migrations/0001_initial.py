    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('banner', models.FileField(blank=True, null=True, upload_to='videos/')),
                ('discount', models.CharField(max_length=255)),
                ('duration', models.CharField(max_length=15)),
                ('status', models.CharField(choices=[('boshlangich', 'Boshlangich'), ("o'rta", "O'rta"), ('yuqori', 'Yuqori')], max_length=150)),
                ('instructor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='courses', to='accounts.teacher')),
